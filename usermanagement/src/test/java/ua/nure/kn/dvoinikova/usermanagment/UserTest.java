package ua.nure.kn.dvoinikova.usermanagment;
...
public class UserTest {
    ...
    private static final String MY_FIRST_NAME = "Inna";
    private static final String MY_LAST_NAME  = "Dvoinikova";
    ...
    public void setUp() throws Exception {
        myDate = new SimpleDateFormat("dd-MM-yyyy").parse("04-12-1998");
