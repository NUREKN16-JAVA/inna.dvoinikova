...
import ua.nure.kn.dvoinikova.usermanagement.web.AddServlet;

import java.text.DateFormat;
import java.util.Date;

public class AddServletTest extends ua.nure.kn.dvoinikova.usermanagement.web.MockServletTestCase {
    @Override
